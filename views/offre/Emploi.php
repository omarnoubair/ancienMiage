...
<body>
    ...
    <div class="row  col-md-9 col-md-offset-1 custyle ">
        <div class="well">
            <h3 class="section-title" style="color: #204d74; margin-left: auto;">Liste d'emplois </h3> 
    <table class="table table-striped custab " style="margin-top:0">
    <thead>
        
        <?php if ($this->session->checkAncien()) { ?>
    <a href="<?php echo BASE_URL."/offres/add/9"?>" class="btn btn-primary btn-xs pull-right"><b>+</b> Ajouter un emploi</a>
        <?php } ?>
        <tr>
            <tr>   
                <th>Responsable</th>
